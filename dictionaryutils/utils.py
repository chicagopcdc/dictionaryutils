...
def node_values_to_codes(data_dictionary_node, record_value, ontology):
    ...
    for variable,value in record_value:
        ...
        if "enumDef" not in data_dictionary_node["properties"][variable]:
            ...
            return_value.append((variable,value))
            continue
        values = [ definition for definition in data_dictionary_node["properties"][variable]["enumDef"] if definition["enumeration"] == value and "termDef" in definition and "source" in definition["termDef"] and definition["termDef"]["source"] == ontology and  definition["termDef"]["code"] ]
        ...
        return_value.append((variable,values[0]["termDef"]["code"]))
